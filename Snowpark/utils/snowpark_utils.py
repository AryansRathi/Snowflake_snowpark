...
def get_snowpark_session() -> Session:
    ...
    elif os.path.exists(os.path.expanduser(r'C:\Users\aryans.rathi\OneDrive - Aquila Capital Holding GmbH\Desktop\Snowpark\.snowsql\config')):
...
def get_snowsql_config(
    ...
    config_file_path: str = os.path.expanduser(r'C:\Users\aryans.rathi\OneDrive - Aquila Capital Holding GmbH\Desktop\Test1\.snowsql\config'),
) -> dict:
    import configparser
...
#     print(f"Connection is not working. Error: {str(e)}")
